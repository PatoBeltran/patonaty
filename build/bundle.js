...
function Trans(_ref) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(useAsParent, additionalProps, renderNodes(components || children, translation, i18n));
}
...
var react_i18next_1 = __webpack_require__(/*! react-i18next */ "./node_modules/react-i18next/dist/es/index.js");
var Backend = __webpack_require__(/*! i18next-xhr-backend */ "./node_modules/i18next-xhr-backend/index.js");
...
var context = __webpack_require__("./src/locales sync recursive \\.json$");
var locales = [];
context.keys().forEach(function (key) {
    // key is of format `en/translations.json`
    // Extract the locale from this path:
    var split = key.split('/');
    var lng = split[split.length - 2];
    locales.push(lng);
});
i18next_1.default
    .use(Backend)
...
i18next_1.default.on('languageChanged', function (lang) {
...
function loadLocales(url, options, callback, data) {
    try {
        var split = url.split('/');
        var locale = __webpack_require__("./src/locales sync recursive ^\\.\\/.*\\.json$")("./" + split[0] + "/" + split[1] + ".json");
...
var map = {
	"./en/translations.json": "./src/locales/en/translations.json",
	"./es/translations.json": "./src/locales/es/translations.json"
};
